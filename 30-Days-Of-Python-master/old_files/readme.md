...
```py
{'name':'djsmacker01', 'country':'Finland', age:250, 'is_married':True}
```
...
```py
('djsmacker01', 'Brook', 'Abraham', 'Lidiya')
```
...
print(type({'name':'djsmacker01'})) # Dictionary
...
```py
first_name, last_name, country, age, is_married = 'djsmacker01', 'Yetayeh', 'Helsink', 250, True
...
print(type({'name':'djsmacker01','age':250, 'is_married':250}))    # dict
...
print('A in djsmacker01', 'A' in 'djsmacker01') # True - A found in the string
print('B in djsmacker01', 'B' in 'djsmacker01') # False -there is no uppercase B
...
[Part 2 >>](https://github.com/djsmacker01/30-Days-Of-Python/blob/master/readme4-6.md)
