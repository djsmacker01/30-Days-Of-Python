...
```py
 lst = ['djsmacker01', 250, True, {'country':'Finland', 'city':'Helsinki'}] # 다른 자료형을 가진 리스트
```
...
1. [국가 목록](https://github.com/djsmacker01/30-Days-Of-Python/tree/master/data/countries.py) 에서 중간 국가를 찾습니다.
